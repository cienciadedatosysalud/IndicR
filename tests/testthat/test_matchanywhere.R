...
### MatchAnyWhere regex_prefix_search =  FALSE, inverse_match_result =  FALSE
...
### MatchAnyWhere regex_prefix_search =  TRUE, inverse_match_result =  FALSE
...
### MatchAnyWhere regex_prefix_search = FALSE, inverse_match_result =  TRUE
definition_codes <- c('F10.10',"I60")
scenario3 <- MatchAnyWhere(reng, "scenario3", target_columns, definition_codes,
                           inverse_match_result =  TRUE,
                           filter_columns = filter_columns,
                           lookup_values = lookup_values)

### MatchAnyWhere regex_prefix_search =  TRUE, inverse_match_result =  TRUE
definition_codes <- c('F10.1','I')
scenario4 <- MatchAnyWhere(reng, "scenario4", target_columns,
                           definition_codes,regex_prefix_search =  TRUE,
                           inverse_match_result =  TRUE,
                           filter_columns = filter_columns,
                           lookup_values = lookup_values)
